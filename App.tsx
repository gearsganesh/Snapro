...
const App: React.FC = () => {
  ...
  const handleDownload = async () => {
    ...
    a.href = url;
    a.download = `gears-snapro-edit-${Date.now()}.jpg`;
    a.click();
  };
      ...
      <header className="h-14 bg-black border-b border-neutral-900 flex justify-between items-center px-4 shrink-0 z-30">
        <div className="flex items-center gap-6">
            <div className="font-bold tracking-[0.25em] text-sm text-white">
                GEARS SNAPRO <span className="text-neutral-600 font-normal">PRO</span>
            </div>
                ...
                <SidebarSection title="Geometry" defaultOpen={false}>
                    ...
                    <div className="grid grid-cols-2 gap-2 mb-4">
                        <button 
                            ...
                            className="bg-neutral-900 hover:bg-neutral-800 text-neutral-300 hover:text-white py-3 rounded flex flex-col items-center justify-center gap-1 transition-colors"
                        >
                             <div className="w-5 h-5">{Icons.Rotate}</div>
                             <span className="text-[10px] uppercase">Rotate 90°</span>
                        </button>
                        <button 
                            onClick={() => updateState('flipH', !imageState.flipH)}
                            className="bg-neutral-900 hover:bg-neutral-800 text-neutral-300 hover:text-white py-3 rounded flex flex-col items-center justify-center gap-1 transition-colors"
                        >
                             <div className="w-5 h-5 transform rotate-90">{Icons.Flip}</div>
                             <span className="text-[10px] uppercase">Mirror</span>
                        </button>
                    </div>
                </SidebarSection>
